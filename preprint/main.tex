...
\author[1]{FEEL Research Project}
\affil[1]{Sweden}
...
\small
\begin{verbatim}
 GPU (AMD Radeon 8060S)         FPGA (Arty A7)
 +---------------------+  UDP   +------------------+
 | Application layer   | 2kHz   | 128 LIF neurons  |
 | - - - - - - - - - - |<=====>| NS-RAM avalanche |
 | HIP kernel jitter   |  ETH   | model (LFSR)     |
 | Firmware (SMN/SMU)  |        |                  |
 | VRM switching noise |        | Spike + Vmem     |
...
\begin{table}[t]
\centering
\caption{Waveform classification accuracy by scale and noise condition.}
\label{tab:classification}
\begin{tabular}{@{}lccc@{}}
\toprule
Configuration & Neurons & Accuracy & Reference \\
\midrule
Single-channel, $1/f$ & 8 & 66.4\% & \expt{2162} \\
Multi-channel noise & 8 & 75.9\% & \expt{2165} \\
128-neuron, full noise & 128 & 81.0\% & \expt{2206} \\
128-neuron, homogeneous & 128 & 81.5\% & \expt{2206} \\
7-level ladder, fusion & 128 & 91.5\% & \expt{2210} \\
\bottomrule
\end{tabular}
\end{table}
...
\bibitem{feel2026}
FEEL Research Project, ``FEEL: Functionally Embodied Emergent
Learning,'' preprint, 2026.
